...
works only with Spark 1.2.x. Therefore, if this version of Spark Cassandra Connector is supposed to
work with Spark 1.1.x, task based metrics have to be disabled.
